...
var msw_aff = { 0:'0', A:'2', F:'3', G:'G', I:'IWATCH', H:'F', S:'ASF', T:'TCS', V:'4', X:'1', B:'AASF', C:'AIWATCH', D:'FFIWATCH', E:'XIWATCH', J:'XASF' };
...
'14003Daily Bugle|Basic Action|Draw 2 dice. Prep up to of them, roll the remainder.',
...
'13003Escape!|Basic Action|Choose one:|* Target character die can\'t be targeted this turn.|Prep a die from your Used Pile.',
...
'12003Invulnerability|Basic Action|Until end of tum, when one of your attacking character dice is KO\'d, return it to the Field Zone.|Global: Pay [B]. Target character die gets +1 attack.',
...
'121F4Invisible Woman|Also Dr Richards|Invisible Woman gets +1 attack for each of your other active [F4] character dice.|Giotal: Pay [M]. Target character die must block this turn.',
...
'12104Madelyne Pryor|Goblin Horde|Energize - Field a [PAWN] from your Used Pile.|While Madelyne Pryor is active, your [PAWN] get +1 detense.',
...
'143V4Scarlet Witch|Chronokinesis|While Scarlet Witch is active, you can reroll the dice in your Reserve Pool at the end of your Main Step.',
...
'133S4Ultimate Spider-Man|Life Raft Stowaway|You may field Ultimate Spider-Man for free.',
...
'232E4Beast|Genius Intellect|While Beast is active, when you field a [F] character die, choose one:|* Deal 2 damage to target character die.|* Target character die gets +2 attack.',
...
'25104Captain Britain|Quantum Reality Manipulation|While Captain Britain is active, at the end of your opponent\'s Roll and Reroll Step, you may rerol a die in your Reserve Pool.',
...
'232A4Falcon|Wings from Black Panther|Recruit - [PAWN].|Global: Pay [F]. Once during your turn, each player must field a [PAWN] from their Used Pile.',
...
'254T4Jane Foster|Valkyrie|When fielded, deal 2 damage to target character die. If that character die has a purchase cost of 4 or more, deal it 5 damage instead.',
...
'233S4Spider-Gwen|The Spectacular|When fielded, deal 5 damage to target character die. Spider-Gwen dice can\'t attack the turn the are fielded.|Global: Pay [B]. If target die deals combat damage to your opponent, put it into your bag instead of the Used Pile.',
...
'252V3Terrax|Herald of Galactus|When fielded, reroll target character die.',
...
'32204Agent Brand|Agent of S.WO.R.D.|When fielded, two target character dice get +1 attack.',
...
'35403God Emperor Doom|Rabum Alal|While God Emperor Doom is active, at the start of the Attack Step, target character die\'s attack becomes O (until end of turn).',
'351T4Goddess of Thunder|Somerson-ofAgard|When fielded, roll X dice from your bag and deal X damage to target character die, where X is equal to the number of active [TCS] character dice in your Field Zone.',
...
'33104Madelyne Pryor|Baroness of Limbo|While Madelyne Pryor Is active, your [PAWN] dice get +1 attack.|Global: Pay [M] and 1 life. Once perturn, field a [PAWN] from your Used Pile.',
...
'152Q4Batman|Rooftops|Energize - Draw and roll 2 dice.|Global: Pay [2M]. Each Player may field up to 2 sidekick dice from their Used Pile.',
...
'242Q4Batman|Contingencies|While you have 2 or more [S] in your Reserve Pool, Batman gets +2A and +2D.|Global: Pay [2M]. Each Player may field up to 2 sidekick dice from their Used Pile.',
...
'462Q4Batman|Batman, Inc.|While Batman is active your Sidekick dice get +2A.|When Batman attacks, swap a Sidekick die in your Field Zone with a Robin die in your Prep Area or Used Pile (at level 1).|Global: Pay [2M]. Each player may field 2 Sidekick dice from their Used Pile.',
...
'173V4Dark Phoenix|Malevolent|Dark Phoenix costs [1] less to purchase if your opponent has an [XMEN] character on their team.|When fielded, KO target character die. If it\'s an [XMEN] character die, deal your opponent 4 damage.|Global: Pay [B] and KO one of your character dice. The next die you purchase this turn costs 2 less (to a minimum of 1).',
...
'161B2Magneto|Idealist|When one of your [M] character dice is KO\'d, put a Loyalty Counter on Magneto\'s card.  (Loyalty Counters give a character die +1A and +1D).|Global: Pay [M]. Once per turn, during your turn, if you have no dice in your Prep Area, you may draw a die and place it in your Prep Area. ',
...
'142B4Sabretooth|Am I Interrupting?|When fielded, KO target Wolverine character die, or any character die with a "While Wolverine is active" ability.',
'123X4Storm|Extreme Weather|When fielded, deal 1 damage to target character die.',
'16104Supreme Intelligence|Kree Science Council|When a card with Kree in its name is KO\'d, put a Loyalty Counter on Supreme Intelligence\'s card. (Loyalty Counters give a character die +1A and +1D).',
...
'263V4Dark Phoenix|Enemy of the Shi\'ar|When fielded, KO target [SHI] or [XMEN] character die.|When Dark Phoenix  attacks, deal 2 damage to your opponent.|Global: Pay [B] and KO one of your character dice. The next die you purchase this turn costs 2 less (to a minimum of 1).',
'242D4Deadpool|More than a Chump Blocker|When Deadpool attacks, he deals your opponent 1 damage.',
...
'223X4Jubilee|Things Never Change|While Wolverine is active, Jubilee gets +1A.',
'231X4Kitty Pryde|Headmistress|While Wolverine is active, Kitty Pryde gets +1A and can\'t be targeted by your opponent.',
'244S4Lilandra|Freedom Fighter|While Lilandra is active, your opponent must spend [1] to use each Action Die.',
'231B4Madelyne Pryor|Sisterhood|When one of your [BOM] character dice is KO\'d besides Madelyne Pryor, put a Loyalty Counter on her card. (Loyalty Counters give a character die +1A and +1D).',
...
'234X3Moira|If It\'s Real|While Wolverine is active, Moira gets +1D.|When fielded, your X-Men character dice get +1A until end of turn.|When Moira is KO\'d, Prep a die from your Used Pile.',
...
'364B4Blob|Immovable|Each of your Blob dice may block 3 character dice instead of 1. When Blob KO\'s a Sidekick die, return it to your opponent\'s bag.',
...
'363X4Cyclops|Utopia Realized|While you have 3 or more character dice in the Field Zone, when Cyclops attacks, deal 3 damage to target character die.',
...
'373V3Dark Phoenix|Destructive Force|When an opposing character die damages Dark Phoenix, she deals that much damage to each opponent.|Global: Pay [B] and KO one of your character dice. The next die you purchase this turn costs 2 less (to a minimum of 1).',
...
'354I4Emma Frost|Finesse|While Emma Frost is Active, at the start of your opponent\'s Attack Step, reroll 2 target [F] character dice your opponent controls. Those showing character faces are returned to the Field Zone, those on energy faces are sent to the Reserve Pool.',
...
'353X3Jean Grey|Marvel Girl|Founder|While Jean Grey is active, your opponent must pay [1] extra to use a Global Ability.|While you have a different [XMEN] character die in your Field Zone, Jean Grey is free to field.',
...
'351B4Magneto|Master of Magnetism|Teamwatch - Spin Target opposing character die to an energy face of your opponent\'s choice.|Global: Pay [M]. Once per turn, during your turn, if you have no dice in your Prep Area, you may draw a die and place it in your prep area.',
...
'334X3Moira|Strength of Foresight|Founder|While Moira is active, when you field an [XMEN] character die with purchase cost of 3 or more put a Loyalty Counter on Moira.|When fielded, you may send target action die from your opponent\'s Field Zone to their Used Pile.',
...
'361X4Professor X|Uncanny Leadership|When fielded, spin an opposing die to its single energy face.|Energize - Move an [XMEN] die from your Used Pile to your Prep Area.',
...
//begin Marvel Infinity Gauntlet
 ...
 '11003Pizza|Basic Action Card|Gain 1 life. You may not use this Basic Action Die if you have 15 or more life.|Global: Pay [S]. Once during your turn, if you have less than 10 life, gain 1 life.',
 '13003Poker Night|Basic Action Card|Gain 1 life. You and your opponent each roll a die from your Used Pile, each player who rolls a character face gains 1 life. Return those dice to the Used Pile. You may only use 1 copy of Poker Night each turn. ',
 '14003Power Surge|Basic Action Card|Each of your active character dice get +1A and +1D (until end of turn).|** Also, up to two target character dice gain Overcrush.|Global: Pay [B]. Target character die gets +1A (until end of turn).',
 '13003Rally!|Basic Action Card|Move up to 2 Sidekick dice from your Used Pile to your Field Zone.|** Instead, move 3 Sidekicks instead.',
 ...
 '152B4Black Dwarf|Powerhouse|When fielded, replace target character die\'s printed A with double its printed A (on all faces) (until end of turn).',
 '152A4Black Panther|Stealthy Adversary|When Black Panther is blocked by at least one non-[PAWN], non-[AV] character die, she gains Overcrush.',
 '143B4Black Swan|The Cabal|While Black Swan is active, if you use an Energize ability gain 1 life.',
 '121A4Black Widow|Space Gem|When fielded, deal 1 damage to target [PAWN].',
 '153V3Bullseye|Imposter Hawkeye|Bullseye costs 1 less to purchase for each character die in your Field Zone showing a * or ** face (minimum 1).|Global: Pay [B]. Target character die gets +1A (until end of turn).',
 '154A4Captain Marvel|Captain Whiz Bang|When Captain Marvel deals combat damage, field a Sidekick die from your Used Pile.',
 '122B3Corvus Glaive|Madness|',
 '141I4Doctor Strange|Time Gem|Energize - Draw and roll a die. That die can\'t be rerolled this turn.|Global: Pay [M]. Target character die must attack this turn.',
 '124I4Drax|The Warrior|Drax is free to field while you have an [IW] character die in your Used Pile.|Global: Pay [S][S]. Target character die gets +1A and +1D.',
 '141B4Ebony Maw|Gleeful Killer|When fielded, deal 2 damage to target character die. If the die is KO\'d by this damage, the next character die you purchase costs 1 less (minimum 1).',
 '142G4Gamora|Genius Trainer|Deadly (At the end of turn, KO all character dice that were engaged with this character.)|Energize - Target character die gets +2A.',
 '13304Ghost Rider|Hellfire|When fielded, deal your opponent X damage, where X is equal to Ghost Rider\'s printed fielding cost.',
 '144G3Groot|Highly Intelligent|Rush - [B] (If you draw this die during your Clear and Draw Step, draw and roll an extra die for each [B] die.)|Global: Pay [S]. Choose an affiliation of a character die you have fielded this turn. Move a character die with that affiliation from your Used Pile to your bag.',
 '161V4Hela|Asgardian|When fielded, each player draws and rolls two dice (placing them in their Reserve Pool).|Global: Pay [F][M]. Target character gains the [DCV] affiliation until the end of the turn.',
 '152A4Hulk|Immortal|Regenerate (Reroll when KO\'d)|Global: Pay [F]. Target character die gets +1A until end of turn.',
 '143A4Iron Lad|Fractured Time Stream|Iron Lad takes no damage from [B] character dice.|Global: Once per turn, pay [B] when a source you control deals damage to a character die or player. If you do, Prep a die from your bag.',
 '144A3Iron Man|Ordinary PhDs|* Prevent all damage done to Iron Man by [DCV] character dice. [DCV] character dice abilities can\'t target Iron Man dice or select Iron Man for any abilities.',
 '131V4Kang|Council of Kangs|Swarm (While this character is active, if you draw this die during your Clear and Draw Step, draw and roll an extra die.)',
 '153V4Loki|Powerful Magic|If you would spin Loki up, always spin him to level 3.|Awaken - Deal 1 damage to target character die and ignore its text until end of turn.',
 '14104Moon Knight|Stronger than 10 Men|While you have at least one [M] in your Reserve Pool, Moon Knight can only be blocked by 2 or more character dice.',
 '134A4Ms. Marvel|NJ Native|',
 ...
 '132V3Sandman|Frightful|While Sandman is active, when your opponent fields a level 3 character die, spin all of your Sandman dice to level 3.',
 ...
 '152G4Star-Lord|Legendary|Recruit - [GG]|While Star-Lord is active, your [GG] dice gain Energize - Target character die gets +1A.',
 '134B4Supergiant|Intangibility|Regenerate (Reroll when KO\'d.)',
 '171B4Thanos|Courting Death|Thanos costs 2 less to purchase (minimum 1) while you have 10 or less life.',
 '151V4The Collector|Stolen Cosmic Cube|Energize - Roll a die from your Used Pile. Place it in your Reserve Pool.|When fielded, You may field a non-Sidekick character die from your Used Pile at level 1. At the end of turn, KO it.|Global: Pay [M]. Once per turn, field a Sidekick die from your Used Pile.',
 '124V4The Spot|Dr. Jonathan Ohnn|Infiltrate (When this character die is unblocked, you may return this die to the FIeld Zone and it deals your opponent 1 damage.)',
 '15304Thor|Scion of All Asgard|Global: Pay [B]. Once per turn, the next action die you purchase this turn costs 2 less (minimum 1).',
 '142V4Tombstone|Eliminating the Competition|Intimidate (When fielded, remove target opposing character die from the Field Zone until end of turn - place it next to your character cards.)|You may KO all of the dice in your Field Zone to field Tombstone for free.',
 '143I4Turk Barrett|Small-Time Crook|Energize - You may deal 2 damage to target character die.',
 '146H4Typhoid Mary|Charming|Recruit - Character die with purchase cost of 2 or less',
 '122M4Wong|Stephen Strange Memorial Institute|Wong gets +2A while Doctor Strange is active, or while you have a Doctor Strange die in your Reserve Pool (on an energy or character face).',
 '241I4Adam Warlock|Hero of Counter Earth|Energize - Move target character die from your Field Zone to your Reserve Pool.',
 '243G4Angela|Odinsdottir|While Angela is active, ignore your opponents "When fielded" abilities.',
 '252B4Black Dwarf|The Black Order|When fielded, KO target character die you control. If you do, the next die you purchase this turn costs [2] less (minimum 1).',
 '252A4Black Panther|Cunning Strategist|When declaring attackers, for each Black Panther character die in your Field Zone that does not attack, target non-[F] character die cannot block.',
 '253B4Black Swan|Our Lady of the Apocalypse|*/** Overcrush (Character dice with Overcrush deal damage in excess of blocker\'s D to opponent.)',
 '231I3Black Widow|Running in the Shadows|Overcrush|Black Widow can only be blocked by [PAWN].',
 '243V4Bullseye|Lester|When fielded, deal 2 damage to target opposing character die, and your opponent may deal 2 damage to a non-Bullseye character die you control.',
 '254A4Captain Marvel|Maj. Carol Danvers|When Captain Marvel deals combat damage, Prep a die from your bag.',
 '232B4Corvus Glaive|Wanton Violence|When fielded, you may deal 1 damage to target character die. Your opponent may deal 1 damage to target [PAWN].',
 '261I4Doctor Strange|Worthy Sorcerer|While Doctor Strange is active, for each [M] energy you spend to purchase an action die or field a character die, deal 1 damage to target character die or player.',
 '244I4Drax|The Meditator|Rush - [B] (If you draw this die during your Clear and Draw Step, draw and roll an extra die for each [B] die.)|Global: Pay [S][S]. Target character die gets +1A and +1D.',
 '241B4Ebony Maw|Twisted Brilliance|When fielded, draw and roll a die (place it in your Reserve Pool).',
 '242G4Gamora|Adventurer|Energize - Field a non-Sidekick character die from your Used Pile at level 1.|* Deadly (At end of turn, KO all character dice that were engaged with this character.)',
 '23304Ghost Rider|Brimstone|While Ghost Rider is active, when an opposing character die deals you non-combat damage, Ghost Rider deals character die 2 damage.',
 '244G4Groot|Quasi-Dimensional Super-Positional Engineer|Recruit- Rocket Racoon.|Global: Pay [S]. Choose an affiliation of a character die you have fielded this turn. Move a character die with that affiliation from your Used Pile to your bag.',
 '261V4Hela|Vengeful|When fielded, reroll target character die.|Global: Pay [2]. Prep a sidekick die from your bag.',
 '262A4Hulk|Professor|When Hulk attacks, reroll target opposing character die. If the result is a level 3 character face, that Hulk die is no longer attacking.|Global: Pay [F]. Target character die gets +1A until end of turn.',
 '243A4Iron Lad|Becoming Kang|When Iron Lad takes damage, deal 1 damage to target character die.|* Deal 2 instead.|Global: Once per turn, pay [B] when a source you control deals damage to a character die or player. If you do, Prep a die from your bag.',
 '244A2Iron Man|Multi-Billionaire|Energize - Gain 2 life.',
 ...
 '244B4Proxima Midnight|Tip of the Spear|Target non-Proxima Midnight [BO] character die gets +2A and gains Overcrush (until end of turn).',
 '223G4Rocket Raccoon|Make Like a Tree|Rush - [S]. (If you draw this die during your Clear and Draw Step, draw and roll an extra die for each [S])',
 '232V3Sandman|Sandilicious!|When one of your Sandman character dice is KO\'d, any other active Sandman character dice have their printed A doubled (on all levels, until end of turn).',
 '284A2She-Hulk|Just Who You Needed!|Overcrush|She-Hulk costs [1] less to purchase for each non-[DCV], non-[PAWN] die in your Field Zone (minimum 1).',
 '25204Spider-Man|Responsibility|Overcrush|Spider-Man costs [1] less to purchase for each of your unique, active character dice (minimum 1).',
 '242G4Star-Lord|Former NASA Mechanic|If you draw any Star-Lord dice during your Clear and Draw Step, for each non-Star-Lord [GG] die you also draw, target character die gains Call Out.|When fielded, draw and roll a die (place it in your Reserve Pool).',
 '254B4Supergiant|Remote Possession|Regenerate (reroll when KO\'d)|When fielded, take control of target character die (until it leaves the Field or end of turn).',
 '271B4Thanos|Overpowering Strength|When Thanos KOs an opposing die, place it in the Used Pile (instead of the Prep Area).',
 '261V3The Collector|Behind the Scenes|When The Collector blocks, Prep 2 dice from your bag. Your opponent can\'t target The Collector with Global Abilities.|Global: Pay [M]. Once per turn, field a Sidekick die from your Used Pile.',
 ...
 '343G4Angela|Asgardian of the Galaxy|While Angela is active, your character dice gain Infiltrate.',
 '352B4Black Dwarf|Giant Axe|When fielded, target non-Black Dwarf character die gets +2A and gains Overcrush (until end of turn).|Global: Pay [0].  Once per turn, on your turn, spin any of your Sidekick dice (in the Field or Reserve Pool) to its [F] face.',
 '352A4Black Panther|Might of Wakanda|When fielded, your opponent must pay [1] or 1 life for each blocker they declare this turn.',
 '353B4Black Swan|Yabbat Ummon Turru|When one or more of your Black Swan character dice attack, you may reroll any of your active character dice.|** You may also reroll any of your active character dice when one or more of your Black Swan character dice block.',
 '321I4Black Widow|Widow\'s Hunt|Energize - Spin target opposing character die down 1 level. If that character die is already level 1, spin it to an energy face (of your choice).',
 '343V4Bullseye|Efficiency|When Bullseye KOs an opposing character die, spin target level 1 character die to an energy face (of your choice).',
 ...
 '332B4Corvus Glaive|Grim Lieutenant|When fielded, you may move a non-Sidekick die from your Used Pile to its card. If you do, deal 2 damage to target character die or player.',
 ...
 '354G4Groot|Jolly Protector|Recruit - Rocket Raccoon|* While Groot is active, prevent the first point of combat damage to you from each attacking character die.|Global: Pay [S]. Choose an affiliation of a character die you have fielded this turn. Move a character die with that affiliation from your Used Pile to your bag.',
 '361V4Hela|Death|When fielded, if you fully spent an energy die to pay for Hela\'s fielding cost, you may reroll that die and place it into your Reserve Pool. (You may only reroll one die, even if you spent more than one.)|Global: Pay [2]. Prep a Sidekick die from your bag.',
 '352A4Hulk|Hunter Green|Call Out (When this character die attacks, target character die is the only character die that may block this character die.)|Global: Pay [F]. Target character die gets +1A until end of turn.',
 '343A4Iron Lad|Slaying Kang|When Iron Lad deals combat damage to your opponent, Prep a die from your bag.|Global: Once per turn, pay [B] when a source you control deals damage to a character die or player. If you do, Prep a die from your bag.',
 ...
 '351V3The Collector|Driven by Purpose|Awaken - Choose an unpurchased character die with purchase cost 3 or less. Field that character die at level one. At the end of the turn or when the die leaves the Field Zone, return it to its card. You may only use this ability once per turn (no matter how many The Collector dice you spin up).|Global: Pay [M]. Once per turn, field a Sidekick die from your Used Pile.',
 '354V4The Spot|Sinister Sixteen|When fielded, deal 1 damage to target character die and reroll a different target character die.',
 '36304Thor|The Golden Avenger|Prevent all damage dealt to Thor if you control 3 or more [AV] character dice.|Global: Pay [B]. Once per turn, the next action die you purchase this turn costs 2 less (minimum 1.)',
 '342V4Tombstone|Witness Intimidation|Intimidate (When fielded, remove target opposing character die from the Field Zone until end of turn - place it next to your character cards.)|While Tombstone is active, your opponent may not purchase or field character dice with a printed cost of [2].',
 '333I4Turk Barrett|Infinity Watch|Energize - You may deal 1 damage to target character die. While Turk Barrett is active, when you roll [B][B] on a die, you may deal 1 damage to target character die or player.',
 ...
 '452G4Gamora|Requiem|While Gamora is active, when your opponent uses an Energize ability you may use a copy of it.|* Deadly (At end of turn, KO all character dice that were engaged with this character.)',
 '462A4Hulk|Unchecked Anger|* If Hulk KOs a character die with combat damage, send that die to the Used Pile instead of the Prep Area.|Global: Pay [F]. Target character die gets +1A until end of turn.',
 '454A4Iron Man|Humble|Awaken - gain 1 life and Prep a die from your bag.',
 '46304Loki|Hero|When fielded, spin up to two target opposing character dice to energy faces (of your opponent\'s choice). If the combined purchase cost was greater than 6, lose 3 life. (Sidekick dice are considered to have a purchase cost of 0.)',
 '454A4Ms. Marvel|Leader of the Champions|Ms. Marvel may not be rerolled by opposing character abilities.',
 '464A4She-Hulk|Astral Planar|Energize - Target character die gets +2A and gains Overcrush. You may also spin this die to its level 1 character face.',
...
//begin WWE Bitter Rivals Team Pack
 ...
 var tag = [
	...
	'04AD4Big E|Powerlifter\'s Physique|While Big E is active, any combat damage to you that is more than 2 is reduced to 2.',
	...
	'045N4Kevin Nash|nWo Wolfpac|Crosspulse - Remove target opposing Superstar die from the Field Zone until end of turn (place it next to your Superstar cards).',
	'045N4Kevin Nash|nWo Founder|Whenever a Kevin Nash Superstar die is damaged while attacking and not KO\'d, deal 2 damage to your opponent.|Global: Pay [F]. Target Superstar die can\'t block this turn unless its owner pays 2 life. You can only use this Global once per Superstar die.',
 ...
 var wwe = [
    '04304AJ Styles|The Face That Runs the Place|While AJ Styles is active, whenever you field a non-AJ Styles Superstar die, each of your active AJ Styles Superstar die gets [sic] +1A and +1D (until end of turn).',
...
var tiw = [
	...
	'041F4g1Tyril|Firbolg Druid|Experience|When any of your character cards gain an Experience token, you may spin this character down 1 level. If you do, gain 2 life.',
...
'052X4Deadpool|It\'s a 4th Wall Thing|When Deadpool attacks, if you have a die on a double energy face in your Reserve Pool, all opposing character dice must block <em>(this turn)</em>.|Global: Pay [F]. Deal 2 damage to target blocking character die.',
...
'041V4Black Adam|Angered|While Black Adam is active, when one of your [DCLOD] character dice KOs an opposing character die, place the KO\'d character die in the Used Pile instead of the Prep Area. (E)',
...
var jus = [
    ...
    '041V5Poison Ivy|A New Leaf|While Poison Ivy is active, when an opponent purchases the last die on a card, deal that opponent 3 damage.|Global: Pay [M] [M]. Once on your turn, you may remove a die on any card from the game. You may not remove the last die on the card.',
    ...
    '042J4The Flash|Always Fast Enough|If The Flash is the first die your purchase this game, he costs [1] less to purchase.|While The Flash is active, when an opponent\'s Attune activates, they lose 1 life.',
...
'03003Wormhole|Basic Action Card|Continuous: Whenever you could use a Global Ability, you may send this die to your Used Pile. If you do, return all dice controlled by a player other than their owner to their owner\'s Field Zone, and return all dice temporarily in the Field Zone to where they originally came from.',							
    ...
    '15404Volstagg|The Voluminous|Overcrush|While Volstagg is active, Hogun and Fandral get +2A and +2D and gain Overcrush.',
    ...
    '354H4Samantha Wilson|Working People, Working Together|While Samantha Wilson is active, when you field a Sidekick die, you may spin a die in your Reserve Pool on an energy face to another energy face (if able).|Global: Pay [S]: Prevent 1 damage to target character die or player.',
    ...
    '34404The Bifrost|Bridge Between Realms|When you field a character die from your Reserve Pool, you may field target character die in your Used Pile on the same level for free. (E)|Global: Pay [0]. Once per turn on your turn, spin one of your Sidekick character dice to itxs [S] face.',
    ...
    '121M4e0Skeleton Key|Lesser Undead|When fielded, you may move target Trap die in the Field Zone to its owner\'s Used Pile.',
    ...
    '23304e1Xandala Cimber|Destined for Greatness|Attune (While this character is active, when you use an action die, deal 1 damage to target player or character die.)|When Xandala Cimber would be KO\'d, instead clear all damage from her if your opponent has any active Good character dice.',
    ...
    '164V4Sentinel|HALT! MUTANT!|While Sentinel is active, when an [XMEN] character die is fielded, deal 2 damage to its controller.',
    ...
    '241E4Morph|Change of Heart|When fielded, choose a Basic Action Card. When Morph attacks, use the ** version of its effect.',
    ...
    '344X4Havok|Blood Brother|While Havok is active, when an [XMEN] character die is damaged, spin it up 1 level before determining if it is KO\'d.',
    ...
    '253A4Ironheart|Reverse-Engineered|When fielded you may add a die from your Used Pile to your bag.|* You may add up to 2 dice instead.',
    ...
    '13204Utility Belt|Anything You Need|Continuous: Whenever you could use a Global Ability, you may send this die to the Used Pile to give target [DCB] character die +3A <em>(until end of turn)</em>.|*/** Then, flip this card.||Begin game with this side face-down.|Continuous: Whenever you could use a Global Ability, you may send this die to the Used Pile to give target [DCB] character die +3A and +3D <em>(until end of turn)</em>. Then, flip this card.',
    ...
    '23104Two-Face™\'s Coin|Heads, I Win|[DCV] character dice you control gain +1A <em>(until end of turn)</em>.|*/** Then, flip this card.||Begin the game with this side face-down.|Opposing non-[DCV] character dice get -1A <em>(until end of turn)</em>. Then, flip this card.',
    ...
    '061V3Shredder|Scarred|When fielded, players must pay 1 life to activate a Global Ability <em>(until end of turn)</em>.',
    ...
    '251B4Dick Grayson|The Hero We Need|When a [DCB] character die is KO\'d, if Dick Grayson is in your Used Pile or Prep Area you may move the KO\'d die to the bag and move Dick Grayson to the Field Zone at level 1.|Global: Pay [M]. Target character die gains [DCB] until end of turn.',
    ...
    '35244Red Skull|"Hail Hydra!"|Teamwatch - when you field a character who shares an affiliation with Red Skull, spin down all of their characters one level or spin up all of your character dice one level (your opponent chooses).',
    ...
    '06302Red-Eyes B. Dragon|Plated Body|While active, [B] monsters cost 2 energy less for you to buy.|* When summoned, move one die from your opponent\'s prep area into the used pile.',
	...
	//IG
	"Black Dwarf":"031 142 062",
	"Black Swan":"144 155*1662",
	"IG@Black Widow":"012 022 123",
	"IG@Bullseye":"031 141 151",
	...
	"Proxima Midnight":"131 142 144",
	"IG@She-Hulk":"146 267 388",
	"IG@Star-Lord":"124 235 255",
	"Supergiant":"012 132 155",
	...
	"OMAC":"133*133 255",
	"SKC@Robin":"022 133 243",
	"SKC@Shazam":"155 265 377",
	"Starro":"011 022 277",
