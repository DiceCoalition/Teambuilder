...
'033S4Wolf Guard Terminator|Chosen Protector|Infiltrate|Reduce all damge dealt to Wolf Guard Terminator from each source to 1.',
'033S4Wolf Guard Terminator|Heroic and Valorous|Reduce all damge dealt to Wolf Guard Terminator from each source to 1.|Wolf Guard Terminator cannot be blocked by [S] or [F] character dice.',
...
'021U4Primaris Intercessor|Versatile|Frag (When a character die with Frag attacks and KOs one or more blocking characeter dice with combat dmage, deal 1 damage to all opposing character dice that did not block this turn, before damage is cleared.)',
...
'03003Big Entrance|Basic Action Card|Impulse - You may add this die to your bag. (Impulse abilities happen when you purchase the die with Impulse.)|Dice purchased this turn cost [1] less than there printed cost (no matter how many Big Entrance dice are used, minimum 1), and gain Impulse - You may add this die to your bag.',							
