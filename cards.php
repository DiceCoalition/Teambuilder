 <script>
  ...
  //BEGIN AVENGERS HACK
    ...
    // Dice / Genders
    var ai =[
'023V4Arnim Zola|Scientist Supreme|When Arnim Zola would be KO\'d, you may pay [1] to clear all damage from him and return him to the Field Zone at level 1 (this does not triggr any When KO\'d effects).',							
...
'02104Avengers ID Cards|Making It Official|[AV] character dice cost [1] less to purchase and are free to field (until end of turn).|*/** Also, Prep a die from your bag. |Global: Pay [M]. Target character die in your Reserve Pool or Field Zone gains [AV] (until end of turn).',							
...
'071A4Doctor Strange|Never Have you Known His Like|While Doctor Strange is active, when an action die is used, you may use a copy fo its effect. You may choose new targets fo the copy.',							
...
'064A4Hulk|Primal Fury|Intimidate (When fielded, removed target opposing character die from the Field Zone until end of turn - place it next to your character cards.)',							
...
'051V4Loki|Throne of Contention|When fielded, choose an affiliation other than [DCV], replacing all previous choices. Your oppoenent can pay 2 life to prevent this effect. While Loki is active, ignore the text (including Global abilities) on all cards of that affiliation. ',							
...
'063A4Thor|Donald Black|When fielded, deal 1 damage to every character die in the FIield Zone. Prep a die from your bag for each character die KO\'d by this effect.',							
...
'03003Big Entrance|Basic Action Card|Impulse - You may add this die to your bag. (Impulse abilities happen when you purchase the die with Impulse.)|Dice purchased this turn cost [1] less than there printed coast (no matter how many Big Entrance dice are used, minimum 1), and gain Impulse - You may add this die to your bag.',							
