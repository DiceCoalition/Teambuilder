...
<!--    <option value="K">Two Team Takedown Legacy</option> -->
   ...
   <option value="T">Roll for the North 3</option><!-- formerly Two Team Takedown -->
  </select>
  </span>  
  </div>
